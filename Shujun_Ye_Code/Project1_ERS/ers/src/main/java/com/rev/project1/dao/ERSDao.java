...
public interface ERSDao {
	 ...
	 */
	Reimbursement subReimb(double reimbAmount, String descrip, int reimbAuthor, int reimbStatusId, int reimbTypeId);
	 ...
	 */
	void updateReimb(Reimbursement r, int resolver, int status);
}
